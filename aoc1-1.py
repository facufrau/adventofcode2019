...
print('---------Parte 1---------')
print('The mass data input of the ship is...')
time.sleep(1)
print (ship_data)
...
for i in range(0, len(ship_data)):
    fuel_calc = 0
    fuel_calc = ( ship_data[i] // 3 ) - 2
    fuel_needed = fuel_needed + fuel_calc

print('The fuel you need for your ship is...')
time.sleep(1)
print(fuel_needed)
...
partial_fuel = []
total_fuel = []
for j in range(0, len(ship_data)):
    current_module = ship_data[j]
